...
请以JSON格式返回:
{{"thought": "我形成的深层观点...", "ideology_layer": "values|worldview|conduct", "spectrum_impact": {{"economic": 0, "social": 0, "diplomatic": 0, "progressive": 0}}, "reasoning": "为什么会产生这样的光谱影响", "confidence": 0.85, "tags": ["关键词1", "关键词2"]}}"""
